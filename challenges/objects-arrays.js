...
*/
let displayNames = [];
const someArr = zooAnimals.forEach((ani) => displayNames.push(`Name:${ani.animal_name} Scientific:${ani.scientific_name}`));
...
let populationTotal = populationA.reduce((total, acc) => total+ acc);
